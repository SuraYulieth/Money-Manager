...
const Login = () => {
  ...
  const handleRegistro = async (correo, contraseña) => {
    try {
  ...
  const functAutentication = async (e) => {
    ...
    if (registrando) {
      try {
        const user = await handleRegistro(correo, contraseña);
        if (user) {
          navigate("/home");
        }
      } catch (error) {
          ...
          <div className="col-lg-6">
            ...
            >
              <div className="card-body p-4">
                <h3 className="text-center mb-4" style={{ fontSize: "2rem", color: "#333" }}>
                    ...
                    <>
                      ...
                      <div className="mb-3">
                        ...
                        >
                          ...
                          <option value="Permiso Permanencia">
